...
exports.update = function (request, response) {
  ...
  var authorId = path.parse(request.params.authorId).base;
  db.query('SELECT * FROM topic', function (error, topics) {
    db.query('SELECT * FROM author WHERE id=?', [authorId], function (error3, selected) {
      db.query('SELECT * FROM author', function (error2, authors) {
        var title = 'Author List';
        var list = template.list(topics);
...
exports.create = function (req, res, post) {
...
exports.author_update_proc = function (req, res, post) {
...
exports.author_delete = function (req, res, post) { //삭제는 반드시 post로 처리해야함
