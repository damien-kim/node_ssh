...
exports.page = function (req, res) {
  var _url = req.url;
  var pageId = path.parse(req.params.pageId).base;
  db.query('SELECT * FROM topic', function (error, topics) {
    if (error) { throw error; }
    db.query(`SELECT * FROM topic LEFT JOIN author on topic.author_id = author.id WHERE topic.id=?`, [pageId], function (error2, topic) { //id=? [배열]물음표 값을 다음 배열에 담아서 넘김. 공격을 세탁해 주는 역할!!
...
exports.create_process = function (req, res, post) {
...
exports.update_process = function (req, res, post) {
...
exports.delete_process = function (req, res, post) {
